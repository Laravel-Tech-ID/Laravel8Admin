...
@section('content')
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-none d-sm-inline-block">
                <a href="{{ route('admin.v1.profile.sakit.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fas fa-edit fa-sm text-white-50"></i> Tambah Data Penyakit</a>    
            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                      <h6 class="m-0 font-weight-bold text-primary">Penyakit {{$personal->user->name}} List</h6>
                    </div>
                    <!-- Card Body -->
                        ...
                        <table class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th width="15%">Pantangan</th>
                                    <th width="15%">Penanganan</th>
                            ...
                            <tbody>
                                @foreach ($datas as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->sakit->nama }}</td>
                                        <td>{{ $data->stadium }}</td>
                                        <td>{{ $data->thn }}</td>
                                        <td>{{ $data->pantangan }}</td>
                                        ...
                                        <td align="center">
                                          <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                              <a href="{{ route('admin.v1.profile.sakit.edit',$data->id) }}" class="dropdown-item">Edit</a>
                                              <form action="{{ route('admin.v1.profile.sakit.destroy',$data->id) }}" method="post">
