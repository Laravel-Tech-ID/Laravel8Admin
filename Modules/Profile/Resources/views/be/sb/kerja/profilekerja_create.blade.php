            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body" style="overflow-x:auto;padding:20px;">
                        <form method="POST" action="{{ route('admin.v1.profile.kerja.store') }}">
                            @csrf
                            ...
                            <div class="form-group row" id="div_ref_pekerjaan_id">
                                ...
                                <div class="col-md-8 mb-3 mb-sm-0">
                                            <select name="ref_pekerjaan_id" id="ref_pekerjaan_id" class="form-control form-control-user @error('ref_pekerjaan_id') is-invalid @enderror" value="{{ old('ref_pekerjaan_id') }}" autocomplete="ref_pekerjaan_id">
                            ...
                            <div class="form-group row" id="div_nama">
                                <label for="nama" class="col-md-3 col-form-label text-md-right">{{ __('Nama Pekerjaan') }}</label>
                            ...
                            <div class="form-group row" id="div_instansi_nama">
                                ...
                                <div class="col-md-8 mb-3 mb-sm-0">
                                    <input id="instansi_nama" type="text" class="form-control form-control-user @error('instansi_nama') is-invalid @enderror" name="instansi_nama" value="{{ old('instansi_nama') }}" autocomplete="instansi_nama" autofocus>
                            ...
                            <div class="form-group row" id="div_instansi_alamat">
                                ...
                                <div class="col-md-8 mb-3 mb-sm-0">
                                    <input id="instansi_alamat" type="text" class="form-control form-control-user @error('instansi_alamat') is-invalid @enderror" name="instansi_alamat" value="{{ old('instansi_alamat') }}" autocomplete="instansi_alamat" autofocus>
                            ...
                            <div class="form-group row" id="div_thn_mulai">
                                ...
                                <div class="col-md-8 mb-3 mb-sm-0">
                                    <input id="thn_mulai" type="number" class="form-control form-control-user @error('thn_mulai') is-invalid @enderror" name="thn_mulai" value="{{ old('thn_mulai') }}" autocomplete="thn_mulai" autofocus>
                            ...
                            <div class="form-group row" id="div_thn_selesai">
                                <label for="thn_selesai" class="col-md-3 col-form-label text-md-right">{{ __('Tahun Selesai (Kosongkan Jika Masih Aktif)') }}</label>
    
                                <div class="col-md-8 mb-3 mb-sm-0">
                                    <input id="thn_selesai" type="number" class="form-control form-control-user @error('thn_selesai') is-invalid @enderror" name="thn_selesai" value="{{ old('thn_selesai') }}" autocomplete="thn_selesai" autofocus>
                            ...
                            <div class="form-group row" id="div_gaji">
                                <label for="gaji" class="col-md-3 col-form-label text-md-right">{{ __('Besar Gaji Per Bulan') }}</label>
    
                                <div class="col-md-8 mb-3 mb-sm-0">
                                    <input id="gaji" type="number" class="form-control form-control-user @error('gaji') is-invalid @enderror" name="gaji" value="{{ old('gaji') }}" autocomplete="gaji" autofocus>
