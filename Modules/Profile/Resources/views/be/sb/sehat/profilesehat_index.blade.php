...
@section('content')
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-none d-sm-inline-block">
                <a href="{{ route('admin.profile.sehat.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fas fa-edit fa-sm text-white-50"></i> Tambah Data Kesehatan</a>    
                                        ...
                                        <td align="center">
                                          <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                              <a href="{{ route('admin.profile.sehat.edit',$data->id) }}" class="dropdown-item">Edit</a>
                                              <form action="{{ route('admin.profile.sehat.destroy',$data->id) }}" method="post">
