...
@section('content')
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Kesehatan {{$personal->user->name}} Management</h1>
            <div class="d-none d-sm-inline-block">
                <a href="{{ route('admin.v1.profile.sehat.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fas fa-edit fa-sm text-white-50"></i> Tambah Data Kesehatan</a>    
            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                      <h6 class="m-0 font-weight-bold text-primary">Kesehatan {{$personal->user->name}} List</h6>
                    </div>
                    <!-- Card Body -->
                                        ...
                                        <td align="center">
                                          <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                              <a href="{{ route('admin.v1.profile.sehat.edit',$data->id) }}" class="dropdown-item">Edit</a>
                                              <form action="{{ route('admin.v1.profile.sehat.destroy',$data->id) }}" method="post">
