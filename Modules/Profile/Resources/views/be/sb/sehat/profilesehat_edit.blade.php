            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body" style="overflow-x:auto;padding:20px;">
                        <form method="POST" action="{{ route('admin.v1.profile.sehat.update',$data->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group row" id="div_tanggal">
                                ...
                                <div class="col-md-8 mb-3 mb-sm-0">
                                    <input id="tanggal" type="date" class="form-control form-control-user @error('tanggal') is-invalid @enderror" name="tanggal" value="{{ $data->tanggal->format('Y-m-d') }}" autocomplete="tanggal" autofocus>
                                    @error('tanggal')
                            ...
                            <div class="form-group row" id="div_tinggi">
                                <label for="tinggi" class="col-md-3 col-form-label text-md-right">{{ __('Data Hobi Baru') }}</label>
                                <div class="col-md-8 mb-3 mb-sm-0">
                                    <input id="tinggi" type="number" class="form-control form-control-user @error('tinggi') is-invalid @enderror" name="tinggi" value="{{ $data->tinggi }}" autocomplete="tinggi" autofocus>    
                                    @error('tinggi')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group row" id="div_berat">
                                <label for="berat" class="col-md-3 col-form-label text-md-right">{{ __('Data Hobi Baru') }}</label>
                                <div class="col-md-8 mb-3 mb-sm-0">
                                    <input id="berat" type="number" class="form-control form-control-user @error('berat') is-invalid @enderror" name="berat" value="{{ $data->berat }}" autocomplete="berat" autofocus>    
                                    @error('berat')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 offset-md-12">
                                    <a href="{{ route('admin.v1.profile.sehat.index') }}" type="submit" class="btn btn-user btn-danger btn-block text-white">
                                        {{ __('Back') }}
                                    </a>
                                </div>
                            </div>
