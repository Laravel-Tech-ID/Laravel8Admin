                    ...
                    <div class="card-body" style="overflow-x:auto;padding:20px;">
                        <form method="POST" action="{{ route('admin.profile.didik.store') }}">
                            ...
                            <div class="form-group row" id="div_thn_mulai">
                                ...
                                <div class="col-md-8 mb-3 mb-sm-0">
                                    <input id="mulai_thn" type="text" class="form-control form-control-user @error('mulai_thn') is-invalid @enderror" name="mulai_thn" value="{{ old('mulai_thn') }}" autocomplete="mulai_thn" required autofocus>    
                                    @error('mulai_thn')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group row" id="div_thn_selesai">
                                ...
                                <div class="col-md-8 mb-3 mb-sm-0">
                                    <input id="lulus_thn" type="text" class="form-control form-control-user @error('lulus_thn') is-invalid @enderror" name="lulus_thn" value="{{ old('lulus_thn') }}" autocomplete="lulus_thn" required autofocus>    
                                    @error('lulus_thn')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
