...
@section('content')
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-none d-sm-inline-block">
                <a href="{{ route('admin.v1.profile.prestasi.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fas fa-edit fa-sm text-white-50"></i> Tambah Data Prestasi</a>    
                            ...
                            <tbody>
                                @foreach ($datas as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->tahun }}</td>
                                        <td>{{ $data->panitia }}</td>
                                        <td align="center"><img src="{{ ($data->sertifikat) ? route('admin.v1.profile.prestasi.file',$data->sertifikat) : asset(config('personal.media').'prestasi/sertifikat.png') }}" width="100px" height="100px"/></td>
                                        <td>{{ $data->tropi }}</td>
                                        <td>{{ $data->ket }}</td>
                                        <td align="center">
                                          <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                              <a href="{{ route('admin.v1.profile.prestasi.edit',$data->id) }}" class="dropdown-item">Edit</a>
                                              <form action="{{ route('admin.v1.profile.prestasi.destroy',$data->id) }}" method="post">
