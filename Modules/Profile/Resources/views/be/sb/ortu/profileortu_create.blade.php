            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body" style="overflow-x:auto;padding:20px;">
                        <form method="POST" action="{{ route('admin.profile.ortu.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row" id="div_ref_ortu_id">
                                ...
                                <div class="col-md-8 mb-3 mb-sm-0">
                                            <select name="ref_ortu_id" id="ref_ortu_id" class="form-control form-control-user @error('ref_ortu_id') is-invalid @enderror" value="{{ old('ref_ortu_id') }}" autocomplete="ref_ortu_id">
                                                <option value="" selected disabled>Pilih dari daftar</option>                                            
                                                @foreach($refs as $ref)
                                                    <option value="{{ $ref->id }}">{{$ref->code}} | {{$ref->name}} | {{ $ref->email }}</option>                                            
                                                @endforeach
                                            </select>
                                            @error('ref_ortu_id')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 offset-md-12">
                                    <a href="{{ route('admin.profile.ortu.index') }}" type="submit" class="btn btn-user btn-danger btn-block text-white">
                                        {{ __('Back') }}
                                    </a>
                                </div>
                            </div>
